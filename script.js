...
body {
    ...
    justify-content: flex-start; /* Alinea al inicio para el nuevo layout */
    align-items: center;
    min-height: 100vh;
    padding-top: 1rem;
...
#splash-screen {
    ...
    width: 100%;
    height: 100%;
    background-color: #111827; /* Un fondo oscuro casi negro */
    display: flex;
...
#main-title {
    ...
    text-shadow: 3px 3px 0 #e53e3e, -3px -3px 0 #3b82f6;
...
#gameCanvas {
    background-color: transparent; /* El fondo del canvas ahora es transparente */
    border-radius: 0.5rem; /* Bordes redondeados */
    display: block;
    width: 100%; /* El lienzo se adapta al ancho del contenedor */
    max-width: 800px; /* Ancho máximo para mantener la proporción */
    height: 400px; /* Altura fija para el lienzo */
    overflow: hidden; /* Evita que los efectos de estela se salgan del canvas */
...
.ui-panel {
    background-color: rgba(45, 55, 72, 0.9); /* Fondo semi-transparente */
    padding: 1rem;
...
.health-bar-container, .power-bar-container {
    width: 100%;
    background-color: #4a5568; /* Color de fondo de la barra vacía */
...
.health-bar, .power-bar {
    height: 100%;
    transition: width 0.3s ease-out; /* Animación de llenado/vaciado */
}
...
@keyframes pulse-yellow {
    ...
    50% { box-shadow: 0 0 10px #fde047, 0 0 20px #fde047; } /* amarillo más claro */
...
#start-message-text {
    font-size: 2.1rem; /* Aproximadamente 15% más pequeño que 2.5rem */
}

/* Estilos para los retratos de selección de personajes */
.character-portrait {
    border: 2px solid #4a5568; /* Borde por defecto */
    transition: all 0.2s ease-in-out; /* Transición suave en hover y selección */
    cursor: pointer;
    background-color: #2d3748; /* Fondo del retrato */
}
.character-portrait:hover {
    border-color: #facc15; /* Borde amarillo al pasar el ratón */
    transform: scale(1.05); /* Ligeramente más grande al pasar el ratón */
}
/* Estilos cuando el personaje es seleccionado por el Jugador 1 */
.character-portrait.selected-p1 {
    border-color: #e53e3e; /* Borde rojo */
    box-shadow: 0 0 15px #e53e3e; /* Sombra roja */
}
/* Estilos cuando el personaje es seleccionado por el Jugador 2 */
.character-portrait.selected-p2 {
    border-color: #3b82f6; /* Borde azul */
    box-shadow: 0 0 15px #3b82f6; /* Sombra azul */
}
.character-portrait img {
    width: 100%;
    height: 100px; /* Altura fija para los retratos */
